<template>
    <div class="relative left-0">
        <div class="flex justify-end pr-10">
            <button
                class="absolute rounded-sm top-0 ml-4 -mt-6 md:mt-4 flex space-x-5 py-2 px-4 bg-cyan-600 text-white -mr-5">
                <div class="pt-1">
                    <h1>Total Produk : {{ total }}</h1>
                </div>
                <svg @click="bagShow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-8 h-8 text-white hover:text-cyan-800">
